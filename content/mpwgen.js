...
loadOptions:function() {
  try {
    window.document.getElementById('mpwgen-username')
        .value=this.getPref('string', 'mpwgen.username');
    window.document.getElementById('mpwgen-email')
        .value=this.getPref('string', 'mpwgen.email');
    window.document.getElementById('mpwgen-autoCompOff')
        .checked=this.getPref('bool', 'mpwgen.autoCompOff');
    window.document.getElementById('mpwgen-rememberDefault')
        .checked=this.getPref('bool', 'mpwgen.rememberDefault');
  } catch (e) { this.dumpErr(e); }
  return true;
},
...
saveOptions:function() {
  try {
    this.setPref('string', 'mpwgen.username',
        window.document.getElementById('mpwgen-username').value);
    this.setPref('string', 'mpwgen.email',
        window.document.getElementById('mpwgen-email').value);
    this.setPref('bool', 'mpwgen.autoCompOff',
        window.document.getElementById('mpwgen-autoCompOff').checked);
    this.setPref('bool', 'mpwgen.rememberDefault',
        window.document.getElementById('mpwgen-rememberDefault').checked);
  } catch (e) { this.dumpErr(e); }
  return true;
},
